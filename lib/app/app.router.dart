...
import 'package:grocery_store/core/data/models/product/product.dart' as _i11;
import 'package:grocery_store/ui/views/favorites/favorites_view.dart' as _i7;
import 'package:grocery_store/ui/views/home/home_view.dart' as _i2;
import 'package:grocery_store/ui/views/login/login_view.dart' as _i4;
...
import 'package:grocery_store/ui/views/product_details/product_details_view.dart'
    as _i6;
import 'package:grocery_store/ui/views/register/register_view.dart' as _i5;
import 'package:grocery_store/ui/views/settings/settings_view.dart' as _i8;
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.notificationsSettingsView,
      page: _i9.NotificationsSettingsView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i7.FavoritesView: (data) {
      ...
      return _i10.MaterialPageRoute<dynamic>(
        builder: (context) => _i7.FavoritesView(key: args.key),
        settings: data,
      );
    },
    ...
    _i9.NotificationsSettingsView: (data) {
      final args = data.getArgs<NotificationsSettingsViewArguments>(
        orElse: () => const NotificationsSettingsViewArguments(),
      );
      return _i10.MaterialPageRoute<dynamic>(
        builder: (context) => _i9.NotificationsSettingsView(key: args.key),
        settings: data,
      );
    },
  };
...
class FavoritesViewArguments {
  const FavoritesViewArguments({this.key});
...
class NotificationsSettingsViewArguments {
  const NotificationsSettingsViewArguments({this.key});
  ...
  @override
  bool operator ==(covariant NotificationsSettingsViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key;
  }
...
extension NavigatorStateExtension on _i12.NavigationService {
  ...
  Future<dynamic> navigateToFavoritesView({
    ...
    return navigateTo<dynamic>(Routes.favoritesView,
        arguments: FavoritesViewArguments(key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToNotificationsSettingsView({
    _i10.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    ...
    return navigateTo<dynamic>(Routes.notificationsSettingsView,
        arguments: NotificationsSettingsViewArguments(key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithNotificationsSettingsView({
    _i10.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    ...
    return replaceWith<dynamic>(Routes.notificationsSettingsView,
        arguments: NotificationsSettingsViewArguments(key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
